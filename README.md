...
Built with NextJS, TypeScript, and Tailwind CSS, this full-stack LMS SaaS App features Clerk Authentication, Payments, AI Conversational Interaction and smooth navigation. Powered by Supabase for backend, database, and file storage, it delivers a responsive, scalable, and intuitive user experience with modern UI/UX best practices.
...
```bash
git clone https://github.com/itzzSVR-tech/Converso.git
cd Converso
```
...
Replace the placeholder values with your actual Supabase, Clerk, Sentry, and Vapi credentials. You can obtain these credentials by signing up on: [Supabase](https://supabase.com/dashboard), [Clerk](https://jsm.dev/converso-clerk), [Sentry](https://jsm.dev/converso-sentry), [Vapi](https://jsm.dev/converso-vapi).
